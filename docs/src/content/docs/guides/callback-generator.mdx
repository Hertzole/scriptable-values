...
:::note
This feature is only available for Unity 2022.2 or later.
:::
...
The source generator supports inheritance in the sense that it will call base methods if it detects that any of the base classes has the [marker attribute](#marker-attribute).
