---
title: Installation
description: Step-by-step guide to install Scriptable Values in your Unity project.
sidebar:
    order: 0
---
...
:::note
The minimum supported Unity version is 2021.3. Older versions may work but are not officially supported nor tested.
:::
