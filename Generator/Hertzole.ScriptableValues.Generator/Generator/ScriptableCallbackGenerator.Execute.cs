...
partial class ScriptableCallbackGenerator
{
        ...
        in CancellationToken cancellationToken)
    {
        ...
        WriteSubscribedEnumMask(in writer, in data, in hierarchy, in cancellationToken);
        ...
        AppendSubscribeMaskTypeName(in writer, in hierarchy);
        writer.Append(' ');
        AppendSubscribeMaskFieldName(in writer, in hierarchy);
    ...
    internal static void WriteSubscribedEnumMask(in CodeWriter writer,
        in EquatableArray<CallbackData> data,
        in HierarchyInfo hierarchy,
        in CancellationToken cancellationToken)
    {
        ...
        in CancellationToken cancellationToken)
    {
        ...
        {
            cancellationToken.ThrowIfCancellationRequested();
            WriteIfCheck(in writer, in elements[i], in hierarchy, true);
        }
        ...
        {
            cancellationToken.ThrowIfCancellationRequested();
            WriteIfCheck(in writer, in elements[i], in hierarchy, false);
        }
    ...
    internal static void AppendSubscribeMaskFieldName(in CodeWriter builder, in HierarchyInfo hierarchy)
    {
        builder.Append("subscribedCallbacks");

        if (hierarchy.ShouldInherit)
        {
            builder.Append(hierarchy.ParentCount);
        }
    }

    internal static void AppendSubscribeMaskTypeName(in CodeWriter builder, in HierarchyInfo hierarchy)
    {
        builder.Append("SubscribedCallbacksMask");
