...
{
    public abstract class GenericEventListenerTest<TListener, TEvent, TValue> : BaseRuntimeTest
        where TListener : ScriptableEventListener<TValue> where TEvent : ScriptableEvent<TValue>
    {
        ...
        [Test]
        public void OnInvoked_WithArgs_ChangeEvent([ValueSource(nameof(eventInvokes))] EventInvokeEvents invokeOn,
