...
{
    /// <summary>
    ///     Base class for all <see cref="ScriptableValue{TValue}" />.
    /// </summary>
    ...
    public abstract partial class ScriptableValue : RuntimeScriptableObject, ICanBeReadOnly
    {
        ...
        /// <summary>
        ///     If <c>true</c>, an equality check will be run before setting the value to make sure the new value is not the same
        ///     as the
        ///     old one.
        /// </summary>
#if SCRIPTABLE_VALUES_PROPERTIES
